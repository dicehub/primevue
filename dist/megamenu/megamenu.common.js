...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2a6ea2c8-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/megamenu/MegaMenu.vue?vue&type=template&id=05b736ec&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.containerClass},[_c('ul',{staticClass:"p-megamenu-root-list",attrs:{"role":"menubar"}},[_vm._l((_vm.model),function(category,index){return [(_vm.visible(category))?_c('li',{key:category.label + '_' + index,class:_vm.getCategoryClass(category),style:(category.style),attrs:{"role":"none"},on:{"mouseenter":function($event){return _vm.onCategoryMouseEnter($event, category)}}},[_c('a',{directives:[{name:"ripple",rawName:"v-ripple"}],class:_vm.getLinkClass(category),attrs:{"href":category.url,"target":category.target,"role":"menuitem","aria-haspopup":category.items != null,"aria-expanded":category === _vm.activeItem,"tabindex":category.disabled ? null : '0'},on:{"click":function($event){return _vm.onCategoryClick($event, category)},"keydown":function($event){return _vm.onCategoryKeydown($event, category)}}},[(category.icon)?_c('span',{class:_vm.getCategoryIcon(category)}):_vm._e(),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(category.label))]),(category.items)?_c('span',{class:_vm.getCategorySubMenuIcon()}):_vm._e()]),(category.items)?_c('div',{staticClass:"p-megamenu-panel"},[_c('div',{staticClass:"p-megamenu-grid"},_vm._l((category.items),function(column,columnIndex){return _c('div',{key:category.label + '_column_' + columnIndex,class:_vm.getColumnClassName(category)},_vm._l((column),function(submenu,submenuIndex){return _c('ul',{key:submenu.label + '_submenu_' + submenuIndex,staticClass:"p-megamenu-submenu",attrs:{"role":"menu"}},[_c('li',{class:_vm.getSubmenuHeaderClass(submenu),style:(submenu.style),attrs:{"role":"presentation"}},[_vm._v(_vm._s(submenu.label))]),_vm._l((submenu.items),function(item,i){return [(_vm.visible(item) && !item.separator)?_c('li',{key:item.label + i,class:_vm.getSubmenuItemClass(item),style:(item.style),attrs:{"role":"none"}},[(item.to && !item.disabled)?_c('router-link',{directives:[{name:"ripple",rawName:"v-ripple"}],class:_vm.getLinkClass(item),attrs:{"to":item.to,"role":"menuitem"},nativeOn:{"click":function($event){return _vm.onLeafClick($event, item)}}},[(item.icon)?_c('span',{class:['p-menuitem-icon', item.icon]}):_vm._e(),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(item.label))])]):_c('a',{directives:[{name:"ripple",rawName:"v-ripple"}],class:_vm.getLinkClass(item),attrs:{"href":item.url,"target":item.target,"role":"menuitem","tabindex":item.disabled ? null : '0'},on:{"click":function($event){return _vm.onLeafClick($event, item)}}},[(item.icon)?_c('span',{class:['p-menuitem-icon', item.icon]}):_vm._e(),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(item.label))]),(item.items)?_c('span',{class:_vm.getSubmenuIcon()}):_vm._e()])],1):_vm._e(),(_vm.visible(item) && item.separator)?_c('li',{key:'separator' + i,class:['p-menu-separator', item.class],style:(item.style),attrs:{"role":"separator"}}):_vm._e()]})],2)}),0)}),0)]):_vm._e()]):_vm._e()]})],2),(_vm.$slots.default)?_c('div',{staticClass:"p-megamenu-custom"},[_vm._t("default")],2):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/megamenu/MegaMenu.vue?vue&type=template&id=05b736ec&
