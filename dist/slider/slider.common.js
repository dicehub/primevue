...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2a6ea2c8-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/slider/Slider.vue?vue&type=template&id=af21108e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"container",class:_vm.containerClass,on:{"click":_vm.onBarClick}},[_c('span',{staticClass:"p-slider-range",style:(_vm.rangeStyle)}),(!_vm.range)?_c('span',{staticClass:"p-slider-handle",style:(_vm.handleStyle),attrs:{"tabindex":"0","role":"slider","aria-valuemin":_vm.min,"aria-valuenow":_vm.value,"aria-valuemax":_vm.max,"aria-labelledby":_vm.ariaLabelledBy},on:{"touchstart":function($event){return _vm.onDragStart($event)},"touchmove":function($event){return _vm.onDrag($event)},"touchend":function($event){return _vm.onDragEnd($event)},"mousedown":function($event){return _vm.onMouseDown($event)},"keydown":function($event){return _vm.onKeyDown($event)}}}):_vm._e(),(_vm.range)?_c('span',{staticClass:"p-slider-handle",style:(_vm.rangeStartHandleStyle),attrs:{"tabindex":"0","role":"slider","aria-valuemin":_vm.min,"aria-valuenow":_vm.value ? _vm.value[0] : null,"aria-valuemax":_vm.max,"aria-labelledby":_vm.ariaLabelledBy},on:{"touchstart":function($event){return _vm.onDragStart($event, 0)},"touchmove":function($event){return _vm.onDrag($event)},"touchend":function($event){return _vm.onDragEnd($event)},"mousedown":function($event){return _vm.onMouseDown($event, 0)},"keydown":function($event){return _vm.onKeyDown($event)}}}):_vm._e(),(_vm.range)?_c('span',{staticClass:"p-slider-handle",style:(_vm.rangeEndHandleStyle),attrs:{"tabindex":"0","role":"slider","aria-valuemin":_vm.min,"aria-valuenow":_vm.value ? _vm.value[1] : null,"aria-valuemax":_vm.max,"aria-labelledby":_vm.ariaLabelledBy},on:{"touchstart":function($event){return _vm.onDragStart($event, 1)},"touchmove":function($event){return _vm.onDrag($event)},"touchend":function($event){return _vm.onDragEnd($event)},"mousedown":function($event){return _vm.onMouseDown($event, 1)},"keydown":function($event){return _vm.onKeyDown($event, 1)}}}):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/slider/Slider.vue?vue&type=template&id=af21108e&
