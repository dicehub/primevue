...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2a6ea2c8-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/menubar/Menubar.vue?vue&type=template&id=9154ca4e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.containerClass},[(_vm.$slots.start)?_c('div',{staticClass:"p-menubar-start"},[_vm._t("start")],2):_vm._e(),_c('a',{ref:"menubutton",staticClass:"p-menubar-button",attrs:{"tabindex":"0"},on:{"click":function($event){return _vm.toggle($event)}}},[_c('i',{staticClass:"pi pi-bars"})]),_c('MenubarSub',{ref:"rootmenu",attrs:{"model":_vm.model,"root":true,"mobileActive":_vm.mobileActive},on:{"leaf-click":_vm.onLeafClick}}),(_vm.$slots.end)?_c('div',{staticClass:"p-menubar-end"},[_vm._t("end")],2):_vm._e()],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/menubar/Menubar.vue?vue&type=template&id=9154ca4e&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2a6ea2c8-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/menubar/MenubarSub.vue?vue&type=template&id=f64a5562&
var MenubarSubvue_type_template_id_f64a5562_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{class:_vm.containerClass,attrs:{"role":_vm.root ? 'menubar' : 'menu'}},[_vm._l((_vm.model),function(item,i){return [(_vm.visible(item) && !item.separator)?_c('li',{key:item.label + i,class:_vm.getItemClass(item),style:(item.style),attrs:{"role":"none"},on:{"mouseenter":function($event){return _vm.onItemMouseEnter($event, item)}}},[(item.to && !item.disabled)?_c('router-link',{directives:[{name:"ripple",rawName:"v-ripple"}],class:_vm.getLinkClass(item),attrs:{"to":item.to,"role":"menuitem"},nativeOn:{"click":function($event){return _vm.onItemClick($event, item)},"keydown":function($event){return _vm.onItemKeyDown($event, item)}}},[_c('span',{class:['p-menuitem-icon', item.icon]}),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(item.label))])]):_c('a',{directives:[{name:"ripple",rawName:"v-ripple"}],class:_vm.getLinkClass(item),attrs:{"href":item.url,"target":item.target,"aria-haspopup":item.items != null,"aria-expanded":item === _vm.activeItem,"role":"menuitem","tabindex":item.disabled ? null : '0'},on:{"click":function($event){return _vm.onItemClick($event, item)},"keydown":function($event){return _vm.onItemKeyDown($event, item)}}},[_c('span',{class:['p-menuitem-icon', item.icon]}),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(item.label))]),(item.items)?_c('span',{class:_vm.getSubmenuIcon()}):_vm._e()]),(_vm.visible(item) && item.items)?_c('sub-menu',{key:item.label + '_sub_',attrs:{"model":item.items,"mobileActive":_vm.mobileActive,"parentActive":item === _vm.activeItem},on:{"leaf-click":_vm.onLeafClick,"keydown-item":_vm.onChildItemKeyDown}}):_vm._e()],1):_vm._e(),(_vm.visible(item) && item.separator)?_c('li',{key:'separator' + i,class:['p-menu-separator', item.class],style:(item.style),attrs:{"role":"separator"}}):_vm._e()]})],2)}
var MenubarSubvue_type_template_id_f64a5562_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/menubar/MenubarSub.vue?vue&type=template&id=f64a5562&
...
var component = normalizeComponent(
  ...
  MenubarSubvue_type_template_id_f64a5562_render,
  MenubarSubvue_type_template_id_f64a5562_staticRenderFns,
  false,
  null,
  null,
  null
