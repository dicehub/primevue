...
// CONCATENATED MODULE: ./src/components/autocomplete/AutoComplete.vue?vue&type=template&id=4587eee3&
...
/* harmony default export */ var AutoCompletevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    inputValue: function inputValue() {
      if (this.value) {
        if (this.field && typeof_typeof(this.value) === 'object') {
