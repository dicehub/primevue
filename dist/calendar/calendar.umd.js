  ...
  methods: {
    ...
    repeat: function repeat(event, interval, type, direction) {
      ...
      this.timePickerTimer = setTimeout(function () {
        _this5.repeat(event, 100, type, direction);
      }, i);
